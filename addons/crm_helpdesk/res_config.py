    ...
    def set_default_alias_prefix(self, cr, uid, ids, context=None):
        ...
        for record in self.browse(cr, uid, ids, context=context):
            ...
            if not alias_id:
                ...
                alias_id = self.pool['mail.alias'].create(cr, uid, {'alias_name': record.alias_prefix_helpdesk}, context=create_ctx)
            else:
                mail_alias.write(cr, uid, alias_id, {'alias_name': record.alias_prefix_helpdesk}, context=context)
        return True
