...
class WebsiteCustomer(http.Controller):
    ...
    def customers(self, country_id=0, page=0, country_name='', tag_id=0, **post):
        ...
        countries = Partner_sudo.read_group(domain, ["id", "country_id"], groupby="country_id", orderby="country_id")
        ...
        partner_count = Partner_sudo.search_count(domain)
        ...
        partners = Partner_sudo.search(domain, offset=pager['offset'], limit=self._references_per_page)
